...
const CategoryLinks = () => {
  ...
  return (
    <div ref={dropdownRef} className=" hidden relative border-gray-300 border-2 px-4 py-[2px] md:flex items-center gap-4">

      <div onClick={toggleDropdown} className="bg-[black] rounded-md flex items-center p-2 gap-4 cursor-pointer">
